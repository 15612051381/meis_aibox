...
public class CRC16Util {
	...
	/**
	 * 查表法计算校验值,注意该方法产生的值为大端，必须转成小端，
	 * 
	 * @param b   待校验的字节数组
	 * @param len 长度
	 * @return 校验值
	 */
	public static int CRC_16_XMODEM_1021(byte[] b, int len) {
		char crc = 0;
		byte hb = 0;
		int j = 0;
		int index;
	 ...
	 * @return 校验值
	 */
	public static int CRC_16_XMODEM_1021(byte[] b, int startidnex, int len) {
		char crc = 0;
		byte hb = 0;
		int j = startidnex;
		int index;
	...
	/**
	 * 计算法得到crc校验值 注意该方法产生的值为大端，必须转成小端，
	 * 
	 * @param bytes
	 * @return
	 */
	 ...
	 * @return 校验值
	 */
	public static int CRC_XModem(byte[] bytes, int startindex, int len) {
		int crc = 0x00; // initial value
		int polynomial = 0x1021;
	...
	/**
	 * 查表法计算校验值,注意该方法产生的值为小端，可直接使用
	 * 
	 * @param b   待校验的字节数组
	 * @param len 长度
	 * @return 校验值
	 */
	public static int GetCrcValue(byte[] b, int len) {

		int temp = CRC_16_XMODEM_1021(b, len);

		byte[] tempcrc = CmdUtils.IntegerToByteArray2(temp);
		...
		return CmdUtils.ByteArray2ToInteger(crcbyte, 0);

	}
	/**
	 * 计算法计算校验值 注意该方法产生的值为小端，可直接使用
	 * 
	 * @param bytes      待校验的字节数组
	 * @param startindex 开始索引
	 * @param len        长度
	 * @return 校验值
	 */
	public static int GetCrcValue(byte[] b, int startidnex, int len) {
		int temp = CRC_16_XMODEM_1021(b, startidnex, len);
		byte[] tempcrc = CmdUtils.IntegerToByteArray2(temp);
