...
public class _0x0408Command extends BaseCommand {
	/**
	...
	public _0x0408Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0408Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0408Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0408Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0408Command)super.GenerateReturnCmd(result);
	}
