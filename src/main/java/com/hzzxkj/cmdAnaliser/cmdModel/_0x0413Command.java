...
public class _0x0413Command extends BaseCommand {
	...
	public _0x0413Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0413Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0413Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0413Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0413Command)super.GenerateReturnCmd(result);
	}
