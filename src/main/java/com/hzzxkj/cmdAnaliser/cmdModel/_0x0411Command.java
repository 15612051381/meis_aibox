...
public class _0x0411Command extends BaseCommand {
	...
	public _0x0411Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0411Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0411Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0411Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0411Command)super.GenerateReturnCmd(result);
	}
