...
public class _0x0307Command extends BaseCommand {
	...
	public _0x0307Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0307Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0307Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0307Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0307Command)super.GenerateReturnCmd(result);
	}
