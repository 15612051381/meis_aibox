...
public class _0x0305Command extends BaseCommand {
	/**
	...
	public _0x0305Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0305Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0305Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0305Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0305Command)super.GenerateReturnCmd(result);
	}
