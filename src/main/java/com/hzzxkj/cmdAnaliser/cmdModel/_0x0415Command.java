...
public class _0x0415Command extends BaseCommand {
	...
	public _0x0415Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0415Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0415Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0415Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0415Command)super.GenerateReturnCmd(result);
	}
