...
public class _0x0308Command extends BaseCommand {
	...
	public _0x0308Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0308Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0308Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0308Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0308Command)super.GenerateReturnCmd(result);
	}
