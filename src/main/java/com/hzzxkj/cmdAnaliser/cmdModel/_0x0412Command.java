...
public class _0x0412Command extends BaseCommand {
	/**
	...
	public _0x0412Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0412Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0412Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0412Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0412Command)super.GenerateReturnCmd(result);
	}
