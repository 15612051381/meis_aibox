...
public class _0x0410Command extends BaseCommand {
	...
	public _0x0410Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0410Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0410Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0410Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0410Command)super.GenerateReturnCmd(result);
	}
