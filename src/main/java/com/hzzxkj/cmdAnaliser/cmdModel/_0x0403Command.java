...
public class _0x0403Command extends BaseCommand {
	/**
	...
	public _0x0403Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0403Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0403Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0403Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0403Command)super.GenerateReturnCmd(result);
	}
