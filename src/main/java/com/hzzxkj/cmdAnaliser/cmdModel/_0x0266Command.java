...
public class _0x0266Command extends BaseCommand {
	...
	public _0x0266Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0266Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0266Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0266Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0266Command)super.GenerateReturnCmd(result);
	}
