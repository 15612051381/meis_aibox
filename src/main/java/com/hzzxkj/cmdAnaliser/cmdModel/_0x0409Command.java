...
public class _0x0409Command extends BaseCommand {
	...
	public _0x0409Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0409Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0409Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0409Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0409Command)super.GenerateReturnCmd(result);
	}
