...
public class _0x0414Command extends BaseCommand {
	...
	public _0x0414Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0414Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0414Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0414Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0414Command)super.GenerateReturnCmd(result);
	}
