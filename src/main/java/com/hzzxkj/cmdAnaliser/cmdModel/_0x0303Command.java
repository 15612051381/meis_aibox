...
public class _0x0303Command extends BaseCommand {
	...
	public _0x0303Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0303Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0303Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0303Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0303Command)super.GenerateReturnCmd(result);
	}
