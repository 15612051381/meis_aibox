...
public class _0x0407Command extends BaseCommand {
	/**
	...
	public _0x0407Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0407Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0407Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0407Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0407Command)super.GenerateReturnCmd(result);
	}
