...
public class _0x0304Command extends BaseCommand {
	...
	public _0x0304Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0304Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0304Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0304Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0304Command)super.GenerateReturnCmd(result);
	}
