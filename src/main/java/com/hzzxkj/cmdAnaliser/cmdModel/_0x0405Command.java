...
public class _0x0405Command extends BaseCommand {
	/**
	...
	public _0x0405Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0405Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0405Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0405Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0405Command)super.GenerateReturnCmd(result);
	}
