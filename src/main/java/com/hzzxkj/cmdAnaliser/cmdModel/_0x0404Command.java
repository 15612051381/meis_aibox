...
public class _0x0404Command extends BaseCommand {
	/**
	...
	public _0x0404Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0404Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0404Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0404Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0404Command)super.GenerateReturnCmd(result);
	}
