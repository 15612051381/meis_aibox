 ...
 *
 */
public class _0x0265Command extends BaseCommand {
	/**
	 * ip地址
	 */
	...
	public _0x0265Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0265Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0265Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0265Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0265Command)super.GenerateReturnCmd(result);
	}
