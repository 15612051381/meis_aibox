...
public class _0x0418Command extends BaseCommand {
	/**
	...
	public _0x0418Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0418Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0418Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0418Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0418Command)super.GenerateReturnCmd(result);
	}
