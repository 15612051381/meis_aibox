...
public class _0x0417Command extends BaseCommand {
	/**
	...
	public _0x0417Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0417Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0417Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0417Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0417Command)super.GenerateReturnCmd(result);
	}
