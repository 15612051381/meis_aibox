...
public class _0x0306Command extends BaseCommand {
	/**
	...
	public _0x0306Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0306Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0306Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0306Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0306Command)super.GenerateReturnCmd(result);
	}
