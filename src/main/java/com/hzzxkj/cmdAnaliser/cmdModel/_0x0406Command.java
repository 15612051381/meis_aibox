...
public class _0x0406Command extends BaseCommand {
	/**
	...
	public _0x0406Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0406Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0406Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0406Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0406Command)super.GenerateReturnCmd(result);
	}
