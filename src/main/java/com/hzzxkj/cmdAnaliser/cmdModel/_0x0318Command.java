 ...
 *
 */
public class _0x0318Command extends BaseCommand {
	...
	public _0x0318Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0318Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0318Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0318Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0318Command)super.GenerateReturnCmd(result);
	}
