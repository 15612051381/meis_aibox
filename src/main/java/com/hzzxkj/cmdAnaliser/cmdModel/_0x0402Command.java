...
public class _0x0402Command extends BaseCommand {
	...
	public _0x0402Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0402Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0402Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0402Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0402Command)super.GenerateReturnCmd(result);
	}
