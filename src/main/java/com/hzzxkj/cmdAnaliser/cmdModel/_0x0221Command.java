...
public class _0x0221Command extends BaseCommand {

	/**
	 * 呼吸机开关机状态  1开机  0 关机
	 */
	public int openCloseStatus;
	...
	public _0x0221Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0221Command GenerateCmdModel(byte[] cmdbyte) {

		return (_0x0221Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0221Command GenerateReturnCmd(boolean result) {

		return (_0x0221Command) super.GenerateReturnCmd(result);
	}
	...
	public void AnalysisSpecialItem() {
		...
		this.openCloseStatus = CmdUtils.ByteToInt(dataByte[0]);
