...
public class _0x0419Command extends BaseCommand {
	...
	public _0x0419Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0419Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0419Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0419Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0419Command)super.GenerateReturnCmd(result);
	}
