...
public class _0x0416Command extends BaseCommand {
	...
	public _0x0416Command(byte[] cmdbyte) {
		GenerateCmdModel(cmdbyte);
	}
	@Override
	public _0x0416Command GenerateCmdModel(byte[] cmdbyte) {
		
		return (_0x0416Command) super.GenerateCmdModel(cmdbyte);
	}

	@Override
	public _0x0416Command GenerateReturnCmd(boolean result) {
		
       return  (_0x0416Command)super.GenerateReturnCmd(result);
	}
