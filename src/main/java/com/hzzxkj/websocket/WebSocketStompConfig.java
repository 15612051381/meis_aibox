...
/**
 * @Author 闫洋洋
 * @Description //TODO websocket配置类,基于STOMP协议
...
public class WebSocketStompConfig implements WebSocketMessageBrokerConfigurer {
    ...
    /**
     * @Author 闫洋洋
     * @Description //TODO 添加这个Endpoint,即前端链接url,并且可以指定是否使用socketjs
     * @Date 14:58 2020/3/13
     * @Param [registry]
     * @return void
     **/
    @Override
    public void registerStompEndpoints(StompEndpointRegistry registry){
         ...
         * 5. setHandshakeHandler 添加拦截处理
         */
        registry.addEndpoint(webSocketEntity.getEndpoint())//可多个
                .setAllowedOrigins(webSocketEntity.getAllowedOrigins())
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry){
        ...
        // 线程池线程数，心跳连接开线程
        taskScheduler.setPoolSize(webSocketEntity.getTaskpoolSize());
        // 线程名前缀
        taskScheduler.setThreadNamePrefix(webSocketEntity.getTaskThreadNamePrefix());
        // 初始化
         ...
         */
        registry.enableSimpleBroker(webSocketEntity.getEnableSimpleBroker())
                .setHeartbeatValue(new long[]{webSocketEntity.getServerHeartbeat(),webSocketEntity.getClientHeartbeat()})
                .setTaskScheduler(taskScheduler);
        /*
         *  "/app" 为配置应用服务器的地址前缀，表示所有以/app 开头的客户端消息或请求
         *  都会路由到带有@MessageMapping 注解的方法中
         */
        registry.setApplicationDestinationPrefixes(webSocketEntity.getApplicationDestinationPrefixes());
    ...
    public void configureWebSocketTransport(WebSocketTransportRegistration registration) {
         ...
         */
        registration.setMessageSizeLimit(webSocketEntity.getMessageSizeLimit())
                .setSendBufferSizeLimit(webSocketEntity.getSendBufferSizeLimit())
                .setSendTimeLimit(webSocketEntity.getSendTimeLimit());
    }
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
         ...
         */
        registration.taskExecutor().corePoolSize(webSocketEntity.getCorePoolSize())
                .maxPoolSize(webSocketEntity.getMaxPoolSize())
                .keepAliveSeconds(webSocketEntity.getKeepAliveSeconds());
        /*
    ...
    /**
     * @Author 闫洋洋
     * @Description //TODO 添加自定义的消息转换器,返回true,会添加spring默认的消息转换器
     * @Date 16:00 2020/3/13
     * @Param [list]
     * @return boolean
     **/
    @Override
    ...
    /**
     * @Author 闫洋洋
     * @Description //TODO 将拦截器注入ico容器中
     * @Date 16:01 2020/3/13
     * @Param []
     * @return com.hzzxkj.websocket.WebSocketChannelInterceptor
     **/
    @Bean
